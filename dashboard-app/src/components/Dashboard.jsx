...
export function Dashboard() {
    ...
    const getDataOnDate = async (date) => {
        const res = await fetch("https://twwai-lab10.herokuapp.com/api/params/search/" + date)
    ...
    const getDay = async () =>{
        const res = await fetch("https://twwai-lab10.herokuapp.com/api/params")
        const dataRes = await res.json();
    ...
    useEffect(() => {
        const fetchAir = async () => {
            const socket = io("https://twwai-lab10.herokuapp.com", {
            ...
            const currentRes = await fetch("https://twwai-lab10.herokuapp.com/api/params/last")
    ...
    return (
        <div style={styles}>
            <div className="col-3">
                ...
                <MyCalendar getData={getDataOnDate} resetData={getDay}/>
            </div>
            <div className="col-9">
